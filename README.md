...
Проект 11 "Анализ взаимодействия пользователей Яндекс-Дзена с карточками статей" - построение дашборда (https://public.tableau.com/app/profile/andrey.ivanov4212/viz/Ivanov_A_A/Dashboard3)      
...
Ключевые навыки: дашборд, пайплайн.
